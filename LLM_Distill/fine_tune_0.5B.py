...
def train_model():
    # 加载模型和tokenizer
    model_name = "/root/root/autodl-tmp/qwen/Qwen2.5-0.5B-Instruct"  # 使用 Qwen2.5-3B 模型
    ...
    args = TrainingArguments(
        output_dir='./results/Qwen2.5-0.5B-Instruct-Lora', 
        num_train_epochs=1, 
        do_train=True, 
    ...
    # 保存模型
    trainer.save_model('./saves/Qwen2.5-0.5B-Instruct-Lora')
    trainer.save_state()
